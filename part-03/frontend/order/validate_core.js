...
function findWasmBinary() {
    return locateFile('validate_core.wasm');
}
...
// Begin JS library code
  ...
  var ___stack_high = 70240;

  var ___stack_low = 4704;

  var ___stack_pointer = new WebAssembly.Global({'value': 'i32', 'mutable': true}, 70240);
...
var _ValidateValueProvided = Module['_ValidateValueProvided'] = makeInvalidEarlyAccess('_ValidateValueProvided');
var _IsIdInArray = Module['_IsIdInArray'] = makeInvalidEarlyAccess('_IsIdInArray');
var _atoi = Module['_atoi'] = makeInvalidEarlyAccess('_atoi');
...
function assignWasmExports(wasmExports) {
  Module['_ValidateValueProvided'] = _ValidateValueProvided = createExportWrapper('ValidateValueProvided', 2);
  Module['_IsIdInArray'] = _IsIdInArray = createExportWrapper('IsIdInArray', 3);
  Module['_atoi'] = _atoi = createExportWrapper('atoi', 1);
...
function stackCheckInit() {
  ...
  // here.
  _emscripten_stack_set_limits(70240 , 4704);
