(module
    ...
    (import "env" "_GenerateCards" (func $GenerateCards))
    (import "env" "_FlipCards" (func $FlipCards))
    (import "env" "_RemoveCards" (func $RemoveCards))
    (import "env" "_LevelComplete" (func $LevelComplete))
    (import "env" "_Pause" (func $Pause))
    ...
    (global $current_level (mut i32) (i32.const 1))
